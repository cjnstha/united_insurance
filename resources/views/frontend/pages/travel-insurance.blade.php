            ...
            <div class="row">
                <div class="col-lg-12 main-renew-buy">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"><a href="{{url('/buy-renew/travel')}}"><img src="{{asset('asset/images/icons/tourism.svg')}}"
                                                                                       alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav sub-side-nav nav-pills">
                        <li><a href="#travel-tab-1-1" data-toggle="tab"> <img src="{{asset('asset/images/icons/claim.png')}}"
                                                                              alt=""> Buy Insurance </a></li>
                        <li><a href="#travel-tab-1-2" data-toggle="tab"><img src="{{asset('asset/images/icons/renew.png')}}"
                ...
                <div class="col-lg-12">
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="travel-tab-1-1">
                            <div class="row justify-content-center">
                                <div
                                    ...
                                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        ...
                                        <form id="msform" action="{{url('/buy-renew/travel/store')}}" method="post"
...
{{--                                                <li id="confirm"><strong>Finish</strong></li>--}}
                                            ...
                                            <br> <!-- fieldsets -->
                                            @csrf
                                            <input type="hidden" value="travel" name="insurance_type">
                                            <fieldset>
                                                <div class="form-card">
                                                    <!-- <div class="row">
                                                                        <div class="col-7">
                                                ...
                                                <div class="form-card">
                                                    <div class="insurance-form">
                                                        ...
                                                        <div class=" col-md-4 form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="place_visit"
                                                                   placeholder="" required="">
                                                        </div>
                                                        <div class=" col-md-4 form-group">
                                                        ...
                                                        <div class=" col-md-4 form-group">
                                                            ...
                                                            <input class="form-control" type="name" name="doctors_name"
                                                                   placeholder="">
                                                        </div>
                                                        <div class=" col-md-4 form-group">
                                                            <label>Doctor's Address (Optional)</label>
                                                            <input class="form-control" type="text"
                                                                   name="doctor_address"
                                                                   placeholder="">
                                                        </div>
                                                        <div class=" col-md-4 form-group">
                                                            <label>Doctor's Contact No. (Optional)</label>
                                                            <input class="form-control" type="text"
                                                                   name="contact_number"
                                                                   placeholder="">
                                                        </div>
                                                        ...
                                                        <div class=" col-md-2 form-group">
                                                            <label>Days</label>
                                                            <input class="form-control" type="number"
                                                                   name="days" placeholder="" required="">
                                                        </div>
                                                        <div class=" col-md-2 form-group">
                                                            <label>$Rate</label>
                                                            <input type="number" class="form-control rate"
                                                                   name="rate" required="required" value="121.17"
                                                                   readonly="readonly">
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label>Plan</label>
                                                            <select name="plan"
                                                                    class="form-control plan_code"
                                                                    onchange="getPlanCovers(this.value)"
                                                                    required="required">
                                                                <option value="">- Select Plan -</option>

                                                                <option value="A">WorldWide excluding USA
                                                                    and Canada (अमेरिका र क्यानाडा बाहेक सबै
                                                                    देशहरु)
                                                                </option>

                                                                <option value="B">WorldWide including USA
                                                                    and Canada (अमेरिका र क्यानाडा सहित सबै
                                                                    देशहरु)
                                                                </option>

                                                                <option value="C">Asian countries excluding
                                                                    SAARC Countries (सार्क देशहरु बाहेक सबै
                                                                    एशियाली देशहरु)
                                                                </option>

                                                                <option value="D">SAARC Countries (सार्क
                                                                    राष्ट्रहरु)
                                                                </option>
                                                            </select>
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <label>Cover</label>
                                                            <select name="cover"
                                                                    class="form-control cover_code"
                                                                    onchange="getTMResult()">
                                                                <option value="I">Medical Only - A to C
                                                                </option>
                                                                <option value="II">Package Policy - A to J
                                                                </option>
                                                            </select>

                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label>Upload Images [Multiple Select]</label>
                                                            <input type="file" name="image[]" multiple="multiple"
                                                                   id="file" onchange="checkFileSize('file');">
                                                            <p style="font-size:12px">(Passport, Citizenship
                                                                Card, PP Size Photo etc.)</p>
                                                        </div>
                                                        <div class="col-md-8 clear form-group">
                                                            ...
                                                            <input type="text" name="policy_date"
                                                                   class="form-control"
                                                                   value="2020-07-02 10:21:23 AM">
                                                            <p style="font-size:12px"><span
                                                                    style="color:#F00">Note:</span> If your
                                                                payment date is after above date, policy
                                                                will be effective from payment
                                                                date.&nbsp;&nbsp;&nbsp;</p>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-pane fade pt-renew bg-form-grey" id="travel-tab-1-2">
                            <form class="product-re-cl-form" autocomplete="on" id="renew-form" name="renew-form"
                                  method="post" action="{{url('/renew-insurance')}}">
                                @csrf
                                <input type="hidden" name="insurance_type" value="travel">
