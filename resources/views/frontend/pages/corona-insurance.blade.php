            ...
            <div class="row">
                <div class="col-lg-12 main-renew-buy">
                    <ul class="nav nav-pills">
                        ...
                        <li><a href="{{url('/buy-renew/property')}}"><img
                                    src="{{asset('asset/images/icons/home.svg')}}" alt="">
                                Property
                                Insurance </a></li>
                        <li class="active"><a href="{{url('/buy-renew/corona-insurance')}}"><img
                                    src="{{asset('asset/images/icons/heart.svg')}}"
                                    alt="">
                                Covid19
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav sub-side-nav nav-pills">
                        <li><a href="#corona-tab-1-1" data-toggle="tab"> <img src="{{asset('asset/images/icons/claim.png')}}"
                                                                                   alt=""> Buy Insurance </a></li>
                        <li><a href="#corona-tab-1-2" data-toggle="tab"><img src="{{asset('asset/images/icons/renew.png')}}"
                ...
                <div class="col-lg-12">
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="corona-tab-1-1">
                            <div class="row justify-content-center">
                                <div
                                    ...
                                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        ...
                                        <form id="msform" action="{{url('/buy-renew/corona-insurance/store')}}"
                                              method="post">
                                            <!-- progressbar -->
                                            <ul id="progressbar">
...
{{--                                                <li id="confirm"><strong>Finish</strong></li>--}}
                                            ...
                                            <br> <!-- fieldsets -->
                                            @csrf
                                            <input type="hidden" name="insurance_type" value="corona-insurance">
                                            <fieldset>
                                                <div class="form-card">
                                                    <!-- <div class="row">
                                                                        <div class="col-7">
                                                    ...
                                                    <div class="insurance-form">
                                                        <div class="col-md-12">
                                                            <div class="col-md-4 form-group">
                                                                ...
                                                                <select name="policy_type" id="ci_type"
                                                                        class="form-control ci_type"
                                                                        required="required">
                                                                    <option value="">- Select Type -
                                                                    </option>

                                                                    <option value="Individual">Individual (1)
                                                                    </option>
                                                            ...
                                                            <div class="col-md-4 form-group">
                                                                ...
                                                                <select name="policy_plan" id="ci_plan"
                                                                        class="form-control ci_plan"
                                                                        required="required"
                                                                        onchange="getCIResult()">
                                                                    <option value="">- Select Plan -
                                                                    </option>

                                                                    <option value="Coverage 100,000/-
                                                                        Plan A (548)">Coverage 100,000/-
                                                                        Plan A (548)
                                                                    </option>

                                                                    <option value="Coverage 50,000/-
                                                                        Plan B (549)">Coverage 50,000/-
                                                                        Plan B (549)
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="col-md-4 form-group">
                                                                ...
                                                                <select name="number_family" id="ci_person"
                                                                        class="form-control"
                                                                        onchange="getCIResult()">
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <tr id="member1">
                                                                            ...
                                                                            <td><input type="text"
                                                                                       ...
                                                                                       maxlength="2"></td>
                                                                            <td>
                                                                                <select name="srelations[]"
                                                                                        id="PersonReln1"
                                                                                        class="form-control PersonReln1">
                                                                                    <option value="">-
                                                                                        Select -
                                                                                    </option>
                                                        ...
                                                        <div class="form-group col-sm-4">
                                                            <label for="">Policy Effective
                                                                From[yyyy-mm-dd]</label>
                                                            <input class="form-control" placeholder="date"
                                                                   name="policy_effective" type="date" value=""
                                                                   required="">
                                                        </div>
                                                        <div class="form-group col-sm-8"><br><span
                                                                style="color:#F00; margin-top: 10px;">Note:</span>
                                                            If your payment date is after above date, policy
                                                            will be effective from payment date.
                                                        </div>
                                                        <div class="form-group terms-area  col-sm-12">
                                                            <input type="checkbox" name="agree" id="agree"
                                                                   class="agree" required="required">
                                                            <p class="terms-text">
                                                                I accept the Terms of Service. I hereby
                                                                declare that the details furnished above are
                                                                true and correct</p>
                                                        </div>
                                                        <div class="form-group terms-area  col-sm-12">
                                                            <input type="checkbox" name="agree" id="agree"
                                                                   class="agree" required="required">
                                                            <p class="terms-text">
                                                                I/we are well known that, my/our family
                                                                members are currently residing in Nepal. No
                                                                members of my family has returned to Nepal
                                                                from foreign countries during this lockdown
                                                                period. I/we have read all the updated
                                                                conditions of the policy terms and obliged
                                                                by the updated conditioned mentioned
                                                                therein. </p>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-pane fade pt-renew bg-form-grey" id="corona-tab-1-2">
                            <form class="product-re-cl-form" autocomplete="on" id="renew-form" name="renew-form"
                                  method="post" action="{{url('/renew-insurance')}}">
                                @csrf
                                <input type="hidden" name="insurance_type" value="corona">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            var fieldHTML = '<div class="controls field_wrapper"><table class="table"><tbody><tr><th>Full Name</th><th width="60px">Age</th><th>Relation</th></tr><tr id="member1"><td><input type="text"name="sfull_name[]"class="form-control"> </td> <td><input type="text"name="sage[]"class="form-control"maxlength="2"></td> <td> <select name="srelations[]"id="PersonReln1"class="form-control PersonReln1"> <option value="">-Select - </option> <option value="1">Husband (1) </option> <option value="2">Wife(2) </option> <option value="3">Son(3) </option> <option value="4">Daughter (4) </option> <option value="5">Fathe(5) </option> <option value="6">Mother(6)</option><option value="7">Brother (7)</option><option value="8">Sister(8)</option><option value="9">Daughter in law (9)</option></select> </td></tr> </tbody></table><a href="javascript:void(0);" class="remove_button" title="Remove field">Remove</a></div></div>'; //New input field html
