				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="padding-out">
							<ul class="insurance-list">
								<li>
									<b>Post:</b> <span>{{$details->team_position}}</span>
								</li>
								<li>
								...
								<li>
									<b>Email Address:</b> <span> <a href="mailto:{{$details->team_email}}" class="transition3s">{{$details->team_email}}</a></span>
								</li>
								<li>
									<b>Contact Number:</b> <span><a href="tel:{{$details->team_phone}}" class="transition3s">{{$details->team_phone}}</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="col-md-4 text-center">
						<div class="single-team-icons">
							<img src="{{asset('images/team/large/'. $details->team_image)}}" alt="">
							<br> <br>
