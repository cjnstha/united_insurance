            ...
            <div class="row">
                <div class="col-lg-12 main-renew-buy">
                    <ul class="nav nav-pills">
                        <li class="active"><a href="{{url('/buy-renew/third-party')}}">
                        ...
                        <li><a href="{{url('/buy-renew/property')}}"><img
                                ...
                                Property
                                Insurance </a></li>
                        <li><a href="{{url('/buy-renew/corona-insurance')}}"><img src="{{asset('asset/images/icons/heart.svg')}}"
                                                                                  alt="">
                                Covid19
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav sub-side-nav nav-pills">
                        <li><a href="#third-party-tab-1-1" data-toggle="tab"> <img src="{{asset('asset/images/icons/claim.png')}}"
                                                                                   alt=""> Buy Insurance </a></li>
                        <li><a href="#third-party-tab-1-2" data-toggle="tab"><img src="{{asset('asset/images/icons/renew.png')}}"
                ...
                <div class="col-lg-12">
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="third-party-tab-1-1">
                            <div class="row justify-content-center">
                                <div
                                    ...
                                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        ...
                                        <form id="msform" action="{{url('/buy-renew/third-party/store')}}"
                                            ...
                                            <br> <!-- fieldsets -->
                                            @csrf
                                            <input type="hidden" value="third-party" name="insurance_type">
                                            <fieldset>
                                                <div class="form-card">
                                                    <!-- <div class="row">
                                                                        <div class="col-7">
                                                ...
                                                <div class="form-card">
                                                    <div class="insurance-form">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input class="form-control" type="text" id="name"
                                                                   name="cubic_capacity" placeholder=" " required>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label>Is Pool?</label>
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            ...
                                                            <input class="form-control" placeholder=" "
                                                                   name="year" type="text" value="" required>
                                                        </div>
                                                        <div class="form-group col-sm-12">
                                                            <label>Registration No.</label>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                            <label>Pradesh / Zonal Code</label>
                                                            <input class="form-control"
                                                                   placeholder=" Eg. Pra 03 / BA" name="pradesh_zone"
                                                                   type="text" value="" required>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                            <label>Lot Number</label>
                                                            <input class="form-control" placeholder=" Eg. 94"
                                                                   name="lot_no" type="number" value="" required>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                            ...
                                                            <select name="vechile_type" class="form-control"
                                                                ...
                                                                <option value="PA">PA (प)</option>
                                                                <option value="BA">BA (ब)</option>
                                                                <option value="THA">THA (थ)</option>
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            ...
                                                            <input class="form-control" placeholder=""
                                                                   name="vechile_id" type="text" value="" required>
                                                        </div>
                                                        <div class=" form-group col-md-3">
                                                            <label>Brand (Made By)</label>
                                                            <select name="brand"
                                                                    class="form-control brand-code"
                                                                    onchange="getBrandModel(this.value)"
                                                                    required="required">
                                                                <option value="">- Select -</option>
                                                                <option value="Anna Lifan">Anna Lifan
                                                                </option>
                                                                <option value="Aprilia">Aprilia</option>
                                                                <option value="Bajaj">Bajaj</option>
                                                                <option value="Bajaj">Benelli</option>
                                                                <option value="BMW MOTORRAD">BMW MOTORRAD
                                                                </option>
                                                                <option value="BSE">BSE</option>
                                                                <option value="Daelim">Daelim</option>
                                                                <option value="Demak">Demak</option>
                                                                <option value="Ducati">Ducati</option>
                                                                <option value="Harly Devidson">Harly Devidson
                                                                </option>
                                                                <option value="Hartford">Hartford</option>
                                                                <option value="Hero Moto Corp">Hero Moto Corp
                                                                </option>
                                                                <option value="Honda">Honda</option>
                                                                <option value="Hyosung">Hyosung</option>
                                                                <option value="INDIAN MOTORCYCLE">INDIAN MOTORCYCLE
                                                                </option>
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            <label>Model</label>
                                                            <input class="form-control" placeholder=""
                                                                   name="model" type="text" value="" required>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                            <label>Chasis Number</label>
                                                            <input class="form-control" placeholder=""
                                                                   name="chasis" type="text" value="" required>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                            <label>Engine Number</label>
                                                            <input class="form-control" placeholder=" "
                                                                   name="engine" type="text" value="" required>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                                    <span class="validation error" id="error-box"
                                                                          style="color:#F00">
                                                                        Please enter CC</span>
                                                            <label>Upload Images [Multiple
                                                                Select] (Example: Scan Image Bill
                                                                Book
                                                                etc.)</label>
                                                        ...
                                                        <div class="form-group col-sm-8"><br/><span
                                                            ...
                                                            If your payment date is after above
                                                            date, policy will be effective from
                                                            payment date.
                                                        </div>
                                                        <div class="form-group terms-area  col-sm-12">
                                                            ...
                                                            <p class="terms-text">
                                                                Accept the Terms
                                                                of Service. I hereby declare
                                                                that the details furnished above
                        ...
                        <div class="tab-pane fade pt-renew bg-form-grey" id="third-party-tab-1-2">
                            <form class="product-re-cl-form" autocomplete="on" id="renew-form" name="renew-form"
                                  method="post" action="{{url('/renew-insurance')}}">
                                @csrf
                                <input type="hidden" name="insurance_type" value="third-party">
