                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-user-plus"></i> Edit Product Detail</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" name="product_name" type="text" id="name" value="{{$products->product_name}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="slider1" class="form-control" id="summary-ckeditor27"
                                                  required>{{$products->details}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="slider2" class="form-control" id="summary-ckeditor28"
                                                  required>{{$products->slider2}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="slider3" class="form-control" id="summary-ckeditor29"
                                                  required>{{$products->slider3}}</textarea>
                                    </div>
                        <div class="form-group">
                            <h3>Nepali Format</h3>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">Product Name</label>
                                <input class="form-control" name="product_name_nep" type="text" id="name" value="{{$products->product_name_nep}}">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">Product File [pdf]</label>
                                <input class="form-control" name="file_pdf" type="file" id="image"
                                       style="padding-top: 3px;">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">Product File [Doc]</label>
                                <input class="form-control" name="file_doc" type="file" id="image"
                                       style="padding-top: 3px;">
                            </div>
                        </div>
