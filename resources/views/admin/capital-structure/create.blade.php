        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('capital.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Capital Structure</label>
                      <textarea id="summary-ckeditor7" name="capital_details" class="form-control"required></textarea>
                  </div>
                    <div class="form-group">
                        <h3>Nepali Format</h3>
                    </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Capital Structure Nepali</label>
                      <textarea id="summary-ckeditor8" name="capital_details_np" class="form-control"required></textarea>
                  </div>
                  <div class="form-group">
