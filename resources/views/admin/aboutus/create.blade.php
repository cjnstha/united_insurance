           ...
           <form action="{{url('/admin/about-us/store')}}" method="post" role="form" enctype="multipart/form-data">
              ...
              <div class="card card-outline card-info">
               ...
               <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                  <div class="mb-3">
                    <textarea class="form-control " id="summary-ckeditor20" name="vision"></textarea>
                  </div>
                </div>
              </div>
               ...
               <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                  <div class="mb-3">
                    <textarea class="form-control " id="summary-ckeditor21" name="mission"></textarea>
                  </div>
                </div>
              </div>
               ...
               <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                  <div class="mb-3">
                    <textarea class="form-control " id="summary-ckeditor22" name="value"></textarea>
                  </div>
                </div>
              </div>
               ...
               <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                  <div class="mb-3">
                    <textarea class="form-control " id="summary-ckeditor23" name="vision_nep"></textarea>
                  </div>
                </div>
              </div>
               ...
               <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                  <div class="mb-3">
                    <textarea class="form-control " id="summary-ckeditor24" name="mission_nep"></textarea>
                  </div>
                </div>
              </div>
               ...
               <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                  <div class="mb-3">
                    <textarea class="form-control " id="summary-ckeditor25" name="value_nep"></textarea>
                  </div>
                </div>
              </div>
