                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-user-plus"></i> Edit Claim Form</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{ route('claim.update',$claims->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{route('claim.index')}}" class="btn btn-outline-danger">Cancel</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
