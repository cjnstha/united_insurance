                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{route('agents.update',$agents->id) }}" method="POST"
