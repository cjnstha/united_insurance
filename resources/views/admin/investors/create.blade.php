        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('investment.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Investment Details**</label>
                      <textarea id="summary-ckeditor15" name="particulars" class="form-control"required></textarea>
                  </div>
                    <div class="form-group">
                        <h3>Nepali Format</h3>
                    </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Investment Details Nepali**</label>
                      <textarea id="summary-ckeditor16" name="particulars_nep" class="form-control"required></textarea>
                  </div>
                  <div class="form-group">
