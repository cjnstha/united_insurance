        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('citizens.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Details*</label>
                      <textarea name="details" id="summary-ckeditor9" class="form-control"required></textarea>
                  </div>
                    <div class="form-group">
                        <h3>Nepali Format</h3>
                    </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Details in Nepali*</label>
                      <textarea name="details_nep" id="summary-ckeditor10" class="form-control"required></textarea>
                  </div>
                  <div class="form-group">
