                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-user-plus"></i> Add PopUp Form</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{ route('popups.store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="" name="description"
                                                  placeholder="Enter PopUp Description" ></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="">PopUp Title in Nepali*</label>
                                        <input type="text" class="form-control" id="" name="popup_title_nep"
                                               placeholder="Enter PopUp Title" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">PopUp Description in Nepali*</label>
