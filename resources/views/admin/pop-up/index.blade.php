                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-outline-primary" href="{{route('popups.create')}}"><i
                                    class="fas fa-user-plus"></i> Add Pop-Up </a>
                                ...
                                @forelse($popups as $key=>$popup)
                                    <tr>
                                        ...
                                        <td data-label="View File">
                                            <a target="_blank" href="{{asset('images/popup/large/'.$popup->image)}}"
                                        ...
                                        <td class="inline-flex">
                                            <a href="{{route('popups.edit', $popup->id)}}" class="btn btn-warning"><i
                                                    class="fas fa-edit"></i> Edit </a>
                                            &nbsp; &nbsp;
                                            <a href="{{route('popups.destroy', $popup->id)}}" class="btn btn-danger"><i
