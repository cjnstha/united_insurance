                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a class="btn btn-outline-primary" href="{{route('galleries.create')}}"><i
                                    class="fas fa-user-plus"></i> Add Gallery </a>
                        </div>
                        <div class="card-body">
                                ...
                                @forelse($galleries as $key=>$gallery)
                                    <tr>
                                        ...
                                        <td data-label="View File">
                                            <a target="_blank" href="{{asset('images/gallery/default/'.$gallery->image)}}"
                                        ...
                                        <td class="inline-flex">
                                            <a href="{{route('galleries.edit', $gallery->id)}}" class="btn btn-warning"><i
