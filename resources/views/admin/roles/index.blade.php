                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-outline-primary" href="{{url('admin/add-role')}}" data-toggle="modal"
                               data-target="#exampleModal"><i class="fas fa-user-plus"></i> Add Roles </a>
                                ...
                                @forelse($roles as $key=>$role)
                                    <tr>
                                        ...
                                        <td class="inline-flex">
                                            ...
                                            &nbsp; &nbsp;
                                            <a href="" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete
                                            </a>
                                        </td>
                                    </tr>
                                @empty
